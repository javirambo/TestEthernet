...
template <uint8_t PIN, uint32_t MASK, bool VALIDPIN>
class _ESPPIN
{
   public:
    ...
    inline static void set(FASTLED_REGISTER port_t val) __attribute__((always_inline)) { *port() = val; }
    ...
    inline static void toggle() __attribute__((always_inline)) { *port() ^= MASK; }
    ...
    inline static port_t hival() __attribute__((always_inline)) { return (*port()) | MASK; }

    inline static port_t loval() __attribute__((always_inline)) { return (*port()) & ~MASK; }

    inline static port_ptr_t port() __attribute__((always_inline)) { return (port_ptr_t)GPIO_REG; }

    inline static port_ptr_t sport() __attribute__((always_inline)) { return (port_ptr_t)GPIO_BIT_SET_REG; }

    inline static port_ptr_t cport() __attribute__((always_inline)) { return (port_ptr_t)GPIO_BIT_CLEAR_REG; }

    inline static port_t mask() __attribute__((always_inline)) { return MASK; }

    inline static bool isset() __attribute__((always_inline)) { return (*port()) & MASK; }
};
...
#define _FL_DEFPIN(PIN)                                                                       \
    template <>                                                                               \
    class FastPin<PIN> : public _ESPPIN<PIN, ((uint32_t)1 << (PIN % 32)), _FL_PIN_VALID(PIN)> \
    {                                                                                         \
    };
