...
struct PixelController
{
    ...
    #define RECOMMENDED_VIRTUAL_BITS                                                                                                                                                                  \
        ((UPDATES_PER_FULL_DITHER_CYCLE > 1) + (UPDATES_PER_FULL_DITHER_CYCLE > 2) + (UPDATES_PER_FULL_DITHER_CYCLE > 4) + (UPDATES_PER_FULL_DITHER_CYCLE > 8) + (UPDATES_PER_FULL_DITHER_CYCLE > 16) \
         + (UPDATES_PER_FULL_DITHER_CYCLE > 32) + (UPDATES_PER_FULL_DITHER_CYCLE > 64) + (UPDATES_PER_FULL_DITHER_CYCLE > 128))
    ...
    }  ///< @copydoc stepAdvanceAndLoadAndScale0(int, uint8_t)
