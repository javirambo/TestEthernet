...
void ESP32_ENC_onEvent() { WiFi.onEvent(ESP32_ENC_event); }

//////////////////////////////////////////////////////////////

void ESP32_ENC_waitForConnect()
{
    while (!ESP32_ENC_eth_connected) delay(100);
}

//////////////////////////////////////////////////////////////

bool ESP32_ENC_isConnected() { return ESP32_ENC_eth_connected; }
